 ...
 * one of the highest selling and addictive games of all time, and a classic of 
 * the arcade era. Your task is to write methods that return the highest score from 
